...
import com.zbensoft.mmsmp.common.ra.common.db.entity.Vasservice;
   ...
   extends JdbcDaoSupport
 {
   ...
   public List<UserOrder> getOrderRelation(String userPhone)
   {
     ...
     logger.debug("OrderRelationDAO getOrderRelation sql:" + sql);
     List<UserOrder> o = getJdbcTemplate().query(sql, new Object[] { userPhone }, new RowMapper()
     {
       public Object mapRow(ResultSet rs, int arg1) throws SQLException {
         UserOrder ret = null;
         if (rs != null) {
   ...
   public void AddOrderRelation(String userPhone, Vasservice service, String provinceCode, String cityCode)
   {
     ...
     getJdbcTemplate().update(sql, new Object[] { Integer.valueOf(hisID), userPhone, userPhone, service.getUniqueid(), "1", service.getFeetype(), 
       service.getOrderfee() });
     ...
     getJdbcTemplate().update(sql, new Object[] { userPhone, userPhone, service.getUniqueid(), "1", service.getFeetype(), 
       service.getOrderfee(), Integer.valueOf(hisID), Integer.valueOf(0), Integer.valueOf(2), service.getIsPackage(), provinceCode });
