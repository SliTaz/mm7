...
public class SmsDataTrans {
    ...
    public static final int ID_CNGP_BIND = 1;
    public static final int ID_CNGP_BIND_RESP = -2147483647;
    public static final int ID_CNGP_UNBIND = 6;
    public static final int ID_CNGP_UNBIND_RESP = -2147483642;
    public static final int ID_CNGP_SUBMIT = 2;
    public static final int ID_CNGP_SUBMIT_RESP = -2147483646;
    public static final int ID_CNGP_DELIVER = 3;
    public static final int ID_CNGP_DELIVER_RESP = -2147483645;
    public static final int ID_CNGP_ACTIVE_TEST = 4;
    public static final int ID_CNGP_ACTIVE_TEST_RESP = -2147483644;
    ...
    public static final int CNGP_IS_REPORT = 1;
    public static final int CNGP_IS_DELIVER = 0;
