...
public class UniBusinessServiceClient {
	...
	public UniBusinessServiceClient() {
		create0();
		Endpoint UniBusinessServiceEP = this.service0.addEndpoint(new QName("http://unibusiness.sjb.vas.aceway.com", "UniBusinessService"),
				new QName("http://unibusiness.sjb.vas.aceway.com", "UniBusinessServiceSoapBinding"), "http://localhost:8080/axis/services/UniBusinessService");
		this.endpoints.put(new QName("http://unibusiness.sjb.vas.aceway.com", "UniBusinessService"), UniBusinessServiceEP);
		Endpoint UniBusinessLocalEndpointEP = this.service0.addEndpoint(new QName("http://unibusiness.sjb.vas.aceway.com", "UniBusinessLocalEndpoint"),
				new QName("http://unibusiness.sjb.vas.aceway.com", "UniBusinessLocalBinding"), "xfire.local://UniBusinessService");
