...
public class ServerHandler extends IoHandlerAdapter
{
	    ...
	    throws Exception
	  {
	    ...
	    if ((message instanceof CheckRequest)) {
	      ...
	      logger.info("the CheckRequest message from corebiz is [gmsgid:" + cRequest.getGlobalMessageid() + ",serviceType:" + cRequest.getServiceType() + ",phone:" + cRequest.getUser_number() + ",sequence:" + cRequest.getSrc_SequenceNumber() + "]");
