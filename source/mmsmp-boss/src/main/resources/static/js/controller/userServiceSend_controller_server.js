...
function ServerSideCtrl(DTOptionsBuilder, DTColumnBuilder, $translate, $scope,
	...
	vm.dtColumns = [
			...
			DTColumnBuilder.newColumn('companyName').withTitle($translate('cpInfo.spInfo')).notSortable().notVisible(),
			...
			DTColumnBuilder.newColumn('productInfoId').withTitle($translate('userServiceSend.productInfoId')).notSortable().notVisible(),
			DTColumnBuilder.newColumn('status').withTitle($translate('userServiceSend.status')).notSortable().renderWith(statusDetail),
			DTColumnBuilder.newColumn('sendTime').withTitle($translate('userServiceSend.sendTime')).notSortable().renderWith(timeRender),
			...
			DTColumnBuilder.newColumn('reportTime').withTitle($translate('userServiceSend.reportTime')).notSortable().renderWith(timeRender).notVisible(),
			DTColumnBuilder.newColumn('sendServiceType').withTitle($translate('userServiceSend.sendServiceType')).notSortable().renderWith(sendServiceTypeDetail).notVisible(),
