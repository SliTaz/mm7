...
public class SMGPConstant {
    ...
    public static final int Query_Resp_Request_Id = -2147483641;
    public static final int MtRoute_Update_Request_Id = 8;
    public static final int MtRoute_Update_Resp_Request_Id = -2147483640;
    public static final int MoRoute_Update_Request_Id = 9;
    public static final int MoRoute_Update_Resp_Request_Id = -2147483639;
