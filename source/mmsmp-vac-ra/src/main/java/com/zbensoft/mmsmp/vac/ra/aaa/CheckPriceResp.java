...
public class CheckPriceResp extends Header {
	...
	private Integer ConfirmInterval = -1;
	...
	public CheckPriceResp() {
		this.CommandId = CMDID_CheckPriceResp;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		resp.setLinkID(new TLV(Common.TAG.LinkID, (short) 3, "asdlfkj"));
		resp.setFeeType(new TLV(Common.TAG.FeeType, (short) 3, "asdlfkj"));
		resp.setSP_ProductID(new TLV(Common.TAG.SP_ProductID, (short) 32, "asdlfkj"));
		resp.setProductID(new TLV(Common.TAG.ProductID, (short) 3, "asdlfkaaaaaaj"));
