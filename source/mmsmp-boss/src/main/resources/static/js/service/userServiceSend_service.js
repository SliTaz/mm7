...
App.factory('UserServiceSendService', ['$http', '$q', function($http, $q){

	return {
		
			fetchAllUserServiceSends: function() {
...
//			},
			...
			deleteUserServiceSend: function(id){
					return $http['delete'](apiUrl +"/userServiceSend/"+id)
							.then(
									function(response){
										return response.data;
									}, 
