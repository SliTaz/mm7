...
public class SyncNotifySPSoapBindingStub extends Stub implements SyncNotifySPService {
	...
	private static void _initOperationDesc1() {
		...
		ParameterDesc param = new ParameterDesc(new QName("", "orderRelationUpdateNotifyRequest"), (byte) 1,
	...
	public OrderRelationUpdateNotifyResponse orderRelationUpdateNotify(
		...
		try {
			...
			try {
				...
				return (OrderRelationUpdateNotifyResponse) JavaUtils.convert(_resp,
