...
public class SmsAPPServer extends SmsHandler {
            ...
            while(true) {
                while(true) {
                    ...
                    if (this.client == null) {
                        ...
                        SmsAPPServer.sreadThread sread = new SmsAPPServer.sreadThread(this.client);
                        sread.start();
                    }
                }
            }
    ...
    public static void main(String[] arg) {
        SmsAPPServer app = new SmsAPPServer("172.16.0.242", 9992);
                ...
                switch(sgip_Cmd.getCommandID()) {
                    ...
                    case 5:
                        ...
                        try {
                            ...
                            pstm = conn.prepareStatement("update test1 set resp = 'Y' where seq1=? and seq2=? and seq3=? ");
                            pstm.setInt(1, (int)report.getSeq_1());
                            pstm.setInt(2, report.getSeq_2());
                            pstm.setInt(3, report.getSeq_3());
                            pstm.executeUpdate();
