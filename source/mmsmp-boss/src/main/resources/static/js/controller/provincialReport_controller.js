'use strict';
var App = angular.module('provincialReportModule', [ 'datatables',
...
function ServerSideCtrl(DTOptionsBuilder, DTColumnBuilder, $translate, $scope,
	...
	vm.dtColumns = [
			...
			DTColumnBuilder.newColumn('buyFee').withTitle($translate('userOrderHis.onDemandFee')).notSortable(),
			DTColumnBuilder.newColumn('newBuyTimes').withTitle($translate('userOrderHis.buyCount')).notSortable(),
			DTColumnBuilder.newColumn('newBuySum').withTitle($translate('userOrderHis.buySum')).notSortable(),
