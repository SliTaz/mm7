...
public class AcewayIoSessionDataStructureFactory implements IoSessionDataStructureFactory {
	public IoSessionAttributeMap getAttributeMap(IoSession arg0) throws Exception {
	...
	private static class DefaultIoSessionAttributeMap implements IoSessionAttributeMap {
		...
		public Set<Object> getAttributeKeys(IoSession session) {
			synchronized (this.attributes) {
				return new HashSet((Collection) this.attributes.keySet());
			}
		}
