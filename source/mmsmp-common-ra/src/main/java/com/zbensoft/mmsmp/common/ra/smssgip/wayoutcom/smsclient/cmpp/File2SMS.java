...
public class File2SMS {
    ...
    public void startStatistic() {
        (new Timer()).schedule(new File2SMS.StatisticTask(), 0L, (long)Integer.parseInt(DbAccess.getProperty("statisticCyc")));
    }

    public void startSearchFile() {
        new File2SMS.SearchFileThread().start();
    }
    ...
    public void startSendSMS() {
        ...
        File2SMS.SendThread send = new File2SMS.SendThread(this.ch, client);
        send.start();
    }
