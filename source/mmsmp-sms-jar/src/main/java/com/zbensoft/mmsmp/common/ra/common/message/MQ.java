...
//		}
	...
	private class MessageReceiverThread extends Thread {
		...
		private ReceiveMessageList receiveList = null;
		...
		public MessageReceiverThread(String mqAppName, String bakMqAppName, ReceiveMessageList receiveList, String queueName) {
