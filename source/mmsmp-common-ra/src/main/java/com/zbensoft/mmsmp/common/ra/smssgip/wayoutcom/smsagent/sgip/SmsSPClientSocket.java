...
public class SmsSPClientSocket extends ClientSocket {
    ...
    private void rmvUnresp() {
        ...
        synchronized(this.sendBuffer) {
            ...
            while(it.hasNext()) {
                SmsSPClientSocket.SeqObject seq = (SmsSPClientSocket.SeqObject)it.next();
    ...
    private void dealBuffer(byte[] buffer, int len) {
        int count = len / 29;
        SmsSPClientSocket.SeqObject[] seq = new SmsSPClientSocket.SeqObject[count];
        ...
        for(int i = 0; i < count; ++i) {
            ...
            seq[i] = new SmsSPClientSocket.SeqObject(seq1, seq2, seq3);
        }
    ...
    SmsSPClientSocket.SeqObject getSeq(ByteBuffer objSMS) {
        long seq1 = (long)objSMS.getInt(8);
        int seq2 = objSMS.getInt(12);
        int seq3 = objSMS.getInt(16);
        return new SmsSPClientSocket.SeqObject(seq1, seq2, seq3);
    }
    ...
    private class SeqObject {
        ...
        public boolean equals(Object o) {
            return o instanceof SmsSPClientSocket.SeqObject && this.seq1 == this.seq1 && this.seq2 == this.seq2 && this.seq3 == this.seq3;
        }
    }
}
