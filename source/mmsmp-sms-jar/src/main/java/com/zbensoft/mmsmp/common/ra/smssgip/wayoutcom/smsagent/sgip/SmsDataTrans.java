...
public class SmsDataTrans {
    ...
    public static String strCorpID = "30237";
    public static String strSPNumber = "8888";
    public static String strRegMax = null;
    public static String strValidNumber = "13";
    ...
    public static final int SGIP_MSGTYPE_SUBMIT = 1;
    public static final int SGIP_MSGTYPE_RESPONSE = 2;
