...
public class SmsDataTrans {
    ...
    public static final int ID_CMPP_BIND = 1;
    public static final int ID_CMPP_BIND_RESP = -2147483647;
    public static final int ID_CMPP_UNBIND = 2;
    public static final int ID_CMPP_UNBIND_RESP = -2147483646;
    ...
    public static final int ID_CMPP_DELIVER_RESP = 5;
    public static final int ID_CMPP_QUERY = 6;
    public static final int ID_CMPP_QUERY_RESP = -2147483642;
    public static final int ID_CMPP_CANCEL = 7;
    public static final int ID_CMPP_CANCEL_RESP = -2147483641;
    public static final int ID_CMPP_ACTIVE_TEST = 8;
    public static final int ID_CMPP_ACTIVE_TEST_RESP = -2147483640;
    ...
    public static final int CMPP_IS_REPORT = 1;
    public static final int CMPP_IS_DELIVER = 0;
