...
public class SmsMessageReceiveServletTest {
	public static void main(String[] args) {
		HttpClient httpClient = new DefaultHttpClient();

		HttpPost post = new HttpPost("http://localhost:8080/MmsOwnbiz/smsMessageReceiveServlet");

		post.setHeader("mmsp-account-id", "123");
		post.setHeader("mmsp-user-number", "13012341234");
		post.setHeader("mmsp-cellphonenumber", "3100201701");
