...
public class OrderRelationUpdateNotifyRequest implements Serializable {
	...
	public OrderRelationUpdateNotifyRequest(String recordSequenceId, Integer userIdType, String userId, String serviceType, String spId, String productId, Integer updateType, String updateTime, String updateDesc,
			String linkId, String content, String effectiveDate, String expireDate, String time_stamp, String encodeStr) {
	...
	public synchronized boolean equals(Object obj) {
		if (!(obj instanceof OrderRelationUpdateNotifyRequest))
			return false;
		...
		boolean _equals = ((this.recordSequenceId == null) && (other.getRecordSequenceId() == null)) || ((this.recordSequenceId != null) && (this.recordSequenceId.equals(other.getRecordSequenceId()))
				&& (((this.userIdType == null) && (other.getUserIdType() == null)) || ((this.userIdType != null) && (this.userIdType.equals(other.getUserIdType())) && (((this.userId == null) && (other
						.getUserId() == null))
						|| ((this.userId != null) && (this.userId.equals(other.getUserId())) && (((this.serviceType == null) && (other.getServiceType() == null)) || ((this.serviceType != null)
								&& (this.serviceType.equals(other.getServiceType())) && (((this.spId == null) && (other.getSpId() == null))
										|| ((this.spId != null) && (this.spId.equals(other.getSpId()))
												&& (((this.productId == null) && (other.getProductId() == null)) || ((this.productId != null) && (this.productId.equals(other.getProductId()))
														&& (((this.updateType == null) && (other.getUpdateType() == null)) || ((this.updateType != null) && (this.updateType.equals(other.getUpdateType()))
																&& (((this.updateTime == null) && (other.getUpdateTime() == null)) || ((this.updateTime != null) && (this.updateTime.equals(other.getUpdateTime()))
																		&& (((this.updateDesc == null) && (other.getUpdateDesc() == null)) || ((this.updateDesc != null) && (this.updateDesc.equals(other.getUpdateDesc()))
																				&& (((this.linkId == null) && (other.getLinkId() == null)) || ((this.linkId != null) && (this.linkId.equals(other.getLinkId()))
																						&& (((this.content == null) && (other.getContent() == null)) || ((this.content != null) && (this.content.equals(other.getContent()))
																								&& (((this.effectiveDate == null) && (other.getEffectiveDate() == null)) || ((this.effectiveDate != null)
																										&& (this.effectiveDate
																												.equals(other.getEffectiveDate()))
																										&& (((this.expireDate == null) && (other.getExpireDate() == null)) || ((this.expireDate != null)
																												&& (this.expireDate.equals(other.getExpireDate()))
																												&& (((this.time_stamp == null) && (other.getTime_stamp() == null)) || ((this.time_stamp != null)
																														&& (this.time_stamp.equals(other.getTime_stamp())) && (((this.encodeStr == null)
																																&& (other.getEncodeStr() == null))
																																|| ((this.encodeStr != null)
