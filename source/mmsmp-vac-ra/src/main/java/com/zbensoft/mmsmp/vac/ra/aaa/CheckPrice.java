...
public class CheckPrice extends Header {
	...
	public CheckPrice(Integer messageid, String threadname) {
		this.SequenceId = messageid;
		this.CommandId = CMDID_CheckPrice;
	...
	public String toString() {
		...
		sb.append(" OA_Type=").append(this.OA_Type);
		sb.append(" OANetwork_ID=").append(this.OANetwork_ID);
		sb.append(" OA=").append(this.OA);
		sb.append(" DA_Type=").append(this.DA_Type);
		sb.append(" DANetwork_ID=").append(this.DANetwork_ID);
		sb.append(" DA=").append(this.DA);
		sb.append(" FAType=").append(this.FAType);
		sb.append(" FANetwork_ID=").append(this.FANetwork_ID);
		sb.append(" FA=").append(this.FA);
		sb.append(" ServiceIDType=").append(this.ServiceIDType);
		sb.append(" SP_ID=").append(this.SP_IDorAccessNo);
		sb.append(" ServiceID=").append(this.ServiceIDorFeatureString);
		sb.append(" ProductID=").append(this.ProductID);
		sb.append(" Service_updown_Type=").append(this.Service_updown_Type);
		sb.append(" Begin_Time=").append(this.Begin_Time);
		sb.append(" ResentTimes=").append(this.ResentTimes);
		...
		sb.append(" SMSFormat=").append(this.SMSFormat);
		sb.append(" SMSContentLen=").append(this.SMSContentLen);
		sb.append(" SMSContent=").append(this.SMSContent);
		sb.append(" CPID=").append(this.CPID);
		sb.append(" ContentID=").append(this.ContentID);
		sb.append(" OrderMethod=").append(this.OrderMethod);
		sb.append(" PushId=").append(this.PushId);
		sb.append(" FeeType=").append(this.FeeType);
		sb.append(" fee=").append(this.Fee);
		sb.append(" AccessNo=").append(this.AccessNo);
		sb.append(" ]");
		return sb.toString();
	}
	...
	public void setLinkID(String linkID) {
		if (linkID != null)
			this.LinkID = new TLV(Common.TAG.LinkID, (short) 20, linkID);
	}
	...
	public void setSMSFormat(String sMSFormat) {
		if (sMSFormat != null)
			this.SMSFormat = new TLV(Common.TAG.SMSFormat, (short) 4, sMSFormat);
	}
	...
	public void setSMSContent(String sMSContent) {
		if (sMSContent != null) {
			...
			this.SMSContentLen = new TLV(Common.TAG.SMSContentLen, (short) 4, String.valueOf(len));
	...
	public void setCPID(String cPID) {
		if (cPID != null)
			this.CPID = new TLV(Common.TAG.CPID, (short) 8, cPID);
	}
	...
	public void setContentID(String contentID) {
		if (contentID != null)
			this.ContentID = new TLV(Common.TAG.ContentID, (short) 22, contentID);
	}
	...
	public void setOrderMethod(String orderMethod) {
		if (orderMethod != null)
			this.OrderMethod = new TLV(Common.TAG.OrderMethod, (short) 4, orderMethod);
	}
	...
	public void setPushId(String pushId) {
		if (pushId != null)
			this.PushId = new TLV(Common.TAG.PushId, (short) 20, pushId);
	}
	...
	public void setFeeType(String feeType) {
		if (feeType != null)
			this.FeeType = new TLV(Common.TAG.FeeType, (short) 2, feeType);
	}
	...
	public void setFee(String fee) {
		if (fee != null)
			this.Fee = new TLV(Common.TAG.Fee, (short) 8, fee);
	}
	...
	public void setAccessNo(String accessNo) {
		if (accessNo != null)
			this.AccessNo = new TLV(Common.TAG.AccessNo, (short) 21, accessNo);
	}

	public static void main(String[] args) throws Exception {
		CheckPrice x = new CheckPrice(Integer.valueOf(111111), "thread0");
		...
		CheckPrice a = new CheckPrice(Integer.valueOf(123456), "thread0");
