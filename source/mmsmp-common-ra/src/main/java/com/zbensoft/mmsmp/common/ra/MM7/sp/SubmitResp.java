...
public class SubmitResp {
	...
	public static String getSubmitResp(String transactionID, String userphone) {
		String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap-env:Envelope xmlns:soap-env=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap-env:Header><TransactionID xmlns=\"http://www.3gpp.org/ftp/Specs/archive/23_series/23.140/schema/REL-5-MM7-1-0\" soap-env:mustUnderstand=\"1\">"
				+ transactionID + "</TransactionID>" + "</soap-env:Header>" + "<soap-env:Body>" + "<mm7:SubmitRsp xmlns:mm7=\"http://www.3gpp.org/ftp/Specs/archive/23_series/23.140/schema/REL-5-MM7-1-0\">"
				+ "<MM7Version>5.2.0</MM7Version>" + "<Status><StatusCode>1000</StatusCode>" + "<StatusText>First:Mmsmp Recevice Success</StatusText></Status>" + "<MessageID>" + transactionID + userphone + "</MessageID>"
				+ "</mm7:SubmitRsp>" + "</soap-env:Body></soap-env:Envelope>";
		return xml;
	}
