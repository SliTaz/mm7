 package com.zbensoft.mmsmp.vas.sjb.unibusiness.dto;
 ...
 public class VasServiceDto
 {
   ...
   public void setSp_productid(String spProductid) { this.sp_productid = spProductid; }
   ...
   public void setSp_notify_ip(String spNotifyIp) { this.sp_notify_ip = spNotifyIp; }
   
   public String getSp_notity_port() {
     return this.sp_notity_port;
   }
   
   public void setSp_notity_port(String spNotityPort) { this.sp_notity_port = spNotityPort; }
   
   public String getOrderRelationurl() {
     return this.orderRelationurl;
   }
   
   public void setOrderRelationurl(String orderRelationurl) { this.orderRelationurl = orderRelationurl; }
 }
