...
public class SyncNumToGWMapInfoHandleThread extends Thread {
    private static final Logger logger = Logger.getLogger(SyncNumToGWMapInfoHandleThread.class);
    private static SyncNumToGWMapInfoHandleThread _instance;
    ...
    public SyncNumToGWMapInfoHandleThread() {
    ...
    public static synchronized void startup() {
        if (_instance == null) {
            _instance = new SyncNumToGWMapInfoHandleThread();
        }

        _instance.start();
        logger.info("SyncNumToGWMapInfoHandleThread start...");
    }
    ...
    private List<File> getFileList() {
        ...
        File[] listFiles = files.listFiles(SyncNumToGWMapInfoHandleThread.VacFileFilter.vff);
    ...
    public static void main(String[] args) {
        (new SyncNumToGWMapInfoHandleThread()).start();
    }
    ...
    private static class VacFileFilter implements FileFilter {
        static final SyncNumToGWMapInfoHandleThread.VacFileFilter vff = new SyncNumToGWMapInfoHandleThread.VacFileFilter();
