...
public class OrderRelationUpdateNotifyResponse implements Serializable {
	...
	static {
		typeDesc.setXmlType(new QName("http://rsp.sync.soap.bossagent.vac.unicom.com", "OrderRelationUpdateNotifyResponse"));
	...
	public synchronized boolean equals(Object obj) {
		...
		boolean _equals = ((this.recordSequenceId == null) && (other.getRecordSequenceId() == null))
				|| ((this.recordSequenceId != null) && (this.recordSequenceId.equals(other.getRecordSequenceId())) && (this.resultCode == other.getResultCode()));
